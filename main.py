...
def main():
    ...
    user_view = UserOP(online_bills, onsite_bills)  # We set the form to be our ExampleApp (design)
    user_view.show()  # Show the form
    op_view = CounterOP(online_bills, onsite_bills, user_view)  # We set the form to be our ExampleApp (design)
